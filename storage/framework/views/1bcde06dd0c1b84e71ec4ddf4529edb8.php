...
<?php if(!empty(config('dashboard.header_height'))): ?>
    <style>
        :root {
            --settings-dashboard-header-height: <?php echo e(config('dashboard.header_height')); ?>rem;
        }
    </style>
<?php endif; ?>
<?php /**PATH /home/johncarlo/Documents/Projects/FREELANCER-TASK/public_html (1)/review/resources/views/blue/partials/head/dashboard-styles.blade.php ENDPATH**/ ?>