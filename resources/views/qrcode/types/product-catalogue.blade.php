...
@section('qrcode-layout-head')
    {!! ContentManager::customCode('Product Catalogue: Head Tag Before Close') !!}
@endsection
...
@section('page')
    <div class="layout-generated-webpage">
        {!! ContentManager::customCode('Product Catalogue: Before Content') !!}
        ...
        <div class="main-page">
            ...
            <div class="restaurant-details">
                <div class="restaurant-name">
                    {{ $composer->qrcodeData('business_name') }}
                </div>
