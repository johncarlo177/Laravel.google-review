...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/lib/grapesjs/grapes.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/lib/grapesjs/grapesjs-preset-webpage.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/lib/grapesjs/tooltip.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/lib/grapesjs/demos.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/lib/grapick/grapick.min.css') }}">

    <script src="{{ asset('assets/lib/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/lib/toastr/toastr.min.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapes.min.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-preset-webpage.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-blocks-basic.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-plugin-forms.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-component-countdown.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-plugin-export.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-tabs.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-custom-code.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-touch.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-parser-postcss.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-tooltip.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-tui-image-editor.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-typed.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-style-bg.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-blocks-table.min.js') }}"></script>
    <script src="{{ asset('assets/lib/grapesjs/grapesjs-tailwind.min.js') }}"></script>

    @include('blue.website-builder.style.head')
</head>
...
<body>
    <div id="gjs" style="height:0px; overflow:hidden">
        ...
        <section class="am-sect">
            <div class="container-width">
                <div class="am-container">
                    <img class="img-phone" onmousedown="return false" src="{{ asset('assets/images/phone-app.png') }}" />
            ...
            <div class="container-width">
                ...
                <div class="badges">
                    <div class="badge">
                        ...
                        <img class="badge-avatar" src="{{ asset('assets/images/team1.jpg') }}">
                    ...
                    <div class="badge">
                        <div class="badge-header"></div>
                        <img class="badge-avatar" src="{{ asset('assets/images/team2.jpg') }}">
                        <div class="badge-body">
                    ...
                    <div class="badge">
                        <div class="badge-header"></div>
                        <img class="badge-avatar" src="{{ asset('assets/images/team3.jpg') }}">
                        <div class="badge-body">
        ...
        @include('blue.website-builder.style.body')
    </div>
    ...
    <div id="info-panel" style="display:none">
        ...
        <div class="info-panel-label">
            <b>Webpage Builder</b> is a simple showcase of what is possible to achieve with the
    ...
    @include('blue.website-builder.script.default')
