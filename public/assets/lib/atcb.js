...
function tzlib_get_offset(t, e, a) {
    ...
    const x = (function () {
        if (b[`${m}`].day[0] == '-') {
            ...
            const e =
                Object.keys(f[`${t}`]).length + 1 - parseInt(b[`${m}`].day[1])
            return f[`${t}`][`${e}`]
        } else {
    ...
    if (t.recurrence != null && t.recurrence != '') {
        ...
        if (
            ...
            if (/^RRULE:/i.test(t.recurrence)) {
                ...
                if (
                    t.recurrence_weekstart == null ||
                    (t.recurrence_weekstart == '') |
                        (t.recurrence_weekstart.length > 2)
                ) {
...
function atcb_decorate_data_options(e) {
    ...
    for (let t = 0; t < e.options.length; t++) {
        ...
        if (
            ...
            (e.recurrence != null &&
                e.recurrence != '' &&
                (!atcbValidRecurrOptions.includes(r) ||
...
function atcb_decorate_data_i18n(t) {
    if (
        t.language == null ||
        t.language == '' ||
        !availableLanguages.includes(t.language)
    ) {
        t.language = 'en'
    }
...
function atcb_decorate_data_dates(e) {
    if (e.dates != null && e.dates.length > 0) {
        for (let t = 0; t < e.dates.length; t++) {
            ...
            e.dates[`${t}`].timestamp = atcb_date_specials_calculation(
                'timestamp',
                e.dates[`${t}`].startDate,
                e.dates[`${t}`].startTime,
                e.dates[`${t}`].timeZone
            )
            e.dates[`${t}`].overdue = atcb_date_specials_calculation(
                'overdue',
                e.dates[`${t}`].endDate,
                e.dates[`${t}`].endTime,
                e.dates[`${t}`].timeZone
        ...
        e.dates[0].overdue = atcb_date_specials_calculation(
            'overdue',
            e.endDate,
            e.endTime,
            e.timeZone
...
function atcb_decorate_data_description(t, e) {
    if (
        ...
        t.dates[`${e}`].descriptionHtmlFree = atcb_rewrite_html_elements(
            t.dates[`${e}`].description,
            true
        )
        t.dates[`${e}`].descriptionHtmlFreeICal = atcb_rewrite_html_elements(
            t.dates[`${e}`].description,
            true,
            true
        )
        t.dates[`${e}`].description = atcb_rewrite_html_elements(
            t.dates[`${e}`].description
        )
    } else {
        if (
            ...
            t.dates[`${e}`].descriptionHtmlFreeICal =
                atcb_rewrite_html_elements(t.description, true, true)
            t.dates[`${e}`].description = atcb_rewrite_html_elements(
                t.description
            )
        } else {
...
function atcb_validate_icsFile(t, e, a = '', n = '') {
    ...
    if (o != '') {
        if (!atcb_secure_url(o, false) || !t.icsFile.startsWith('https://')) {
            t.validationError =
                e + ' failed: explicit ics file path not valid' + n
            return false
        }
    }
    return true
...
function atcb_validate_buttonStyle(t, e) {
    ...
    if (
        t.customCss != null &&
        t.customCss != '' &&
        (!atcb_secure_url(t.customCss, false) || !/\.css$/m.test(t.customCss))
    ) {
        t.validationError = e + ' failed: customCss provided, but no valid url'
        return false
    }
    if (
        (t.customCss == null || t.customCss == '') &&
        t.buttonStyle == 'custom'
    ) {
        t.validationError =
            e +
...
function atcb_validate_status(t, e, a, n) {
    if (
        t.dates[`${a}`].status != 'TENTATIVE' &&
        t.dates[`${a}`].status != 'CONFIRMED' &&
        t.dates[`${a}`].status != 'CANCELLED'
    ) {
        t.validationError =
            e +
...
function atcb_validate_availability(t, e, a, n) {
    if (
        t.dates[`${a}`].availability != null &&
        t.dates[`${a}`].availability != '' &&
        t.dates[`${a}`].availability != 'free' &&
        t.dates[`${a}`].availability != 'busy'
    ) {
        t.validationError =
            e + ' failed: event availability needs to be "free" or "busy"' + n
        return false
    }
    return true
}
...
function atcb_validate_datetime(a, n, o, i) {
            ...
            if (a.dates[`${o}`][`${t}`] != null) {
                ...
                if (t == 'startTime') {
                    r.startDate = new Date(
                        r.startDate.getTime() + e[0] * 36e5 + e[1] * 6e4
                    )
                }
                if (t == 'endTime') {
                    r.endDate = new Date(
                        r.endDate.getTime() + e[0] * 36e5 + e[1] * 6e4
                    )
                }
            }
            return true
    ...
    if (
        (a.dates[`${o}`].startTime != null &&
            a.dates[`${o}`].endTime == null) ||
        (a.dates[`${o}`].startTime == null && a.dates[`${o}`].endTime != null)
    ) {
        a.validationError =
            n +
...
function atcb_validate_rrule_simplyfied(t, e) {
    ...
    if (
        ...
        t.validationError =
            e + ' failed: recurrence data (byMonthDay) misspelled'
        return false
    }
    if (
        t.recurrence_byDay != null &&
        t.recurrence_byDay != '' &&
        !/^(\d|-|MO|TU|WE|TH|FR|SA|SU|,)+$/im.test(t.recurrence_byDay)
    ) {
    ...
    if (
        t.recurrence_weekstart != null &&
        t.recurrence_weekstart != '' &&
        !/^(MO|TU|WE|TH|FR|SA|SU)$/im.test(t.recurrence_weekstart)
    ) {
        t.validationError =
            e + ' failed: recurrence data (weekstart) misspelled'
        return false
    }
    return true
}
function atcb_toggle(t, e, a = '', n = null, o = false, i = false) {
    if (e == 'open') {
        ...
        e == 'close' ||
        n.classList.contains('atcb-active') ||
...
function atcb_open(a, n, t = null, e = false, o = false) {
    ...
    if (n.listStyle === 'modal') {
        const c = atcb_generate_bg_overlay(
            a,
            n.trigger,
            true,
            !n.hideBackground
...
function atcb_close(e, a = false) {
    ...
    if (o.length > 1) {
        n.shadowRoot
            ...
            .remove()
        const i = n.shadowRoot.querySelectorAll(
        ...
        Array.from(e.querySelectorAll('.atcb-list-wrapper'))
            ...
            .concat(
                Array.from(
                    e.querySelectorAll('#add-to-calendar-button-reference')
                )
            )
...
function atcb_generate_label_content(t, e, a, n, o, i) {
    ...
    const l = {
        ...
        apple: o || 'Apple',
        google: o || 'Google',
        ical: o || atcb_translate_hook('label.icalfile', t),
    ...
    if (
        ((a == 'trigger' || i) && !t.hideTextLabelButton) ||
        (!i && a != 'trigger' && !t.hideTextLabelList)
    ) {
...
function atcb_generate_button(i, r, l, t = false) {
    const c = (function () {
        if (
            l.options.length === 1 ||
            (l.buttonsList && l.buttonStyle != 'date')
        ) {
            return true
        }
        return false
...
function atcb_create_modal(n, o, t = '', e, a = '', i = [], r = [], l = false) {
    ...
    const s = (function () {
        ...
        if (!t) {
            const e = atcb_generate_bg_overlay(
                n,
                'click',
                true,
                !o.hideBackground
...
function atcb_generate_date_button(b, t, u = 'all') {
    ...
    const e = (function () {
        ...
        if (
            !o.allday &&
            Intl.DateTimeFormat().resolvedOptions().timeZone != a &&
            a != n
        ) {
            l = ' (' + a + ')'
        }
        ...
        if (
            t.toLocaleDateString(b.language, d.DateLong) ===
            e.toLocaleDateString(b.language, d.DateLong)
        ) {
            if (o.allday) {
                r = t.toLocaleDateString(b.language, s.DateShort)
            } else {
                r =
                    t.toLocaleString(b.language, s.DateTimeShort) +
                    l +
                    ' - ' +
                    e.toLocaleTimeString(b.language, d.Time) +
                    c
            }
        } else {
            if (o.allday) {
    ...
    const a = (function () {
        if (u != 'all' && b.dates[`${u}`].status == 'CANCELLED') {
            return (
                atcb_translate_hook('date.status.cancelled', b) +
                '<br>' +
                atcb_translate_hook('date.status.cancelled.cta', b)
            )
        }
...
function atcb_generate_modal_host(t, e, a = true) {
    ...
    o.attachShadow({ mode: 'open', delegateFocus: true })
    const i = document.createElement('template')
    i.innerHTML =
        '<div class="atcb-modal-host-initialized" style="position:relative;"></div>'
        ...
        if (e.images != null) {
            if (Array.isArray(e.images)) {
                for (let t = 0; t < e.images.length; t++) {
                    if (
                        atcb_secure_url(e.images[`${t}`], e.debug) &&
...
function atcb_generate_rich_data_recurrence(t, e) {
    ...
    const n =
        'P' + t.recurrence_interval + t.recurrence_frequency.substring(0, 1)
    ...
    if (t.recurrence_byMonth != null && t.recurrence_byMonth != '') {
        const i = t.recurrence_byMonth.includes(',')
            ? '[' + t.recurrence_byMonth + ']'
            : t.recurrence_byMonth
        a.push('"byMonth":"' + i + '"')
    }
    if (t.recurrence_byMonthDay != null && t.recurrence_byMonthDay != '') {
        const r = t.recurrence_byMonthDay.includes(',')
            ? '[' + t.recurrence_byMonthDay + ']'
            : t.recurrence_byMonthDay
        a.push('"byMonthDay":"' + r + '"')
    }
    ...
    if (n != 'all') {
        if (a.dates[`${n}`].status == 'CANCELLED' && r != 'ical') {
            atcb_create_modal(
                ...
                a,
                'warning',
                atcb_translate_hook('date.status.cancelled', a),
                atcb_translate_hook('date.status.cancelled.cta', a),
                [],
                [],
                o
            )
        ...
        if (l) {
            const s = l.shadowRoot.getElementById(
                a.identifier + '-' + e + '-' + (n + 1)
            )
            if (s) {
...
function atcb_generate_multidate_links(t, e, a, n, o, i) {
    if (
        a == 'ical' &&
        n.dates.every(function (t) {
            if (
                t.status == 'CANCELLED' ||
                (t.organizer != null && t.organizer != '')
            ) {
                return false
            }
            return true
    ...
    if (!i) {
        ...
        atcb_create_modal(
            ...
            n,
            e,
            atcb_translate_hook('modal.multidate.h', n),
            atcb_translate_hook('modal.multidate.text', n),
            [],
            r,
            o
        )
...
function atcb_subscribe_google(t) {
    ...
    const a = (function () {
        if (
            t.startsWith('https://calendar.google.com/') ||
            t.startsWith('webcal://calendar.google.com/') ||
            t.startsWith('http://calendar.google.com/') ||
            t.startsWith('//calendar.google.com/')
        ) {
...
function atcb_generate_google(t) {
    ...
    if (n.length > 0) {
        e.push('details=' + encodeURIComponent(n.join()))
    }
    if (t.recurrence != null && t.recurrence != '') {
...
function atcb_generate_msteams(t) {
    ...
    const n = atcb_generate_time(t, 'delimiters', 'microsoft')
...
function atcb_generate_ical(t, a, e = 'all', n = false) {
    ...
    if (e == 'all') {
        ...
        if (
            a.dates[`${e}`].status != null &&
            a.dates[`${e}`].status == 'CANCELLED'
        ) {
            l.push('METHOD:CANCEL')
        } else {
            if (
                a.dates[`${e}`].organizer != null &&
                a.dates[`${e}`].organizer != ''
            ) {
    ...
    for (let e = s; e <= d; e++) {
        ...
        if (
            a.dates[`${e}`].descriptionHtmlFreeICal != null &&
            a.dates[`${e}`].descriptionHtmlFreeICal != ''
        ) {
            l.push(
                'DESCRIPTION:' +
        ...
        if (
            a.dates[`${e}`].location != null &&
            a.dates[`${e}`].location != ''
        ) {
            l.push(
                'LOCATION:' +
                    atcb_rewrite_ical_text(a.dates[`${e}`].location, true)
            )
        }
        if (
            a.dates[`${e}`].organizer != null &&
            ...
            l.push(
                'ORGANIZER;CN="' +
                    atcb_rewrite_ical_text(p[0], false, true) +
                    '":MAILTO:' +
                    p[1]
            )
        }
        if (
            a.dates[`${e}`].attendee != null &&
            a.dates[`${e}`].attendee != ''
        ) {
            const g = a.dates[`${e}`].attendee.split('|')
            l.push(
                'ATTENDEE;ROLE=REQ-PARTICIPANT;CN="' +
                    atcb_rewrite_ical_text(g[0], false, true) +
                    '":MAILTO:' +
                    g[1]
            )
        }
...
function atcb_generate_time(t, e = 'delimiters', a = 'general', n = false) {
    if (
        ...
        if (
            (t.timeZone == null || (t.timeZone != null && t.timeZone == '')) &&
            n
        ) {
            return {
        ...
        if (t.timeZone != null && t.timeZone != '') {
            ...
            const m =
                parseInt(b[0] + 1) *
                -1 *
                ((parseInt(b.substring(1, 3)) * 60 +
                    parseInt(b.substring(3, 5))) *
                    60 *
                    1e3)
...
function atcb_format_datetime(t, e = 'delimiters', a = true, n = false) {
    ...
    const i = n
        ? t.toISOString().replace(o, '').replace('Z', '')
        : t.toISOString().replace(o, '')
    return i
}
...
function atcb_position_list(t, e, a, n = false, o = false) {
    ...
    if (i === true && !a.classList.contains('atcb-dropoverlay')) {
        ...
        if (
            (a.classList.contains('atcb-dropup') && o) ||
            (!n &&
                !o &&
                l.top + t.height > d - 20 &&
                2 * c.top + c.height - l.top - t.height > 20)
        ) {
        ...
        a.style.left =
            Math.round(l.left - s.left - (t.width - l.width) / 2) + 'px'
    } else {
        ...
        a.style.margin =
            -Math.round((u.height + c.height) / 2) +
            'px ' +
            m +
            'px 0 ' +
            m +
...
const i18nStrings = {
    ...
    de: {
        ...
        'modal.crios.ical.text':
            'Leider hat Chrome unter iOS Probleme mit der Art, wie wir Kalender-Dateien erzeugen.',
        'modal.crios.ical.steps':
    ...
    fr: {
        ...
        'modal.crios.ical.text':
            'Malheureusement, Chrome sur iOS a des problèmes avec la façon dont nous générons le fichier agenda.',
        'modal.crios.ical.steps':
    ...
    ro: {
        ...
        'modal.crios.ical.text':
            'Din nefericire, Chrome pe iOS are probleme cu modalitatile prin care noi generam fisierele pentru scalendar.',
        'modal.crios.ical.steps':
...
function atcb_read_attributes(n) {
    ...
    for (let t = 0; t < atcbWcParams.length; t++) {
        ...
        if (n.hasAttribute(`${a}`)) {
            let e = atcb_secure_content(
                n.getAttribute(`${a}`).replace(/(\\r\\n|\\n|\\r)/g, ''),
                false
            )
            let t
        ...
        if (e != null && e != '') {
            o['identifier'] = atcb_secure_content(
                e.replace(/(\\r\\n|\\n|\\r)/g, ''),
                false
            )
        }
...
function atcb_action(e, a, n = false) {
    ...
    const t = document.getElementById(
        'atcb-customTrigger-' + e.identifier + '-host'
    )
    if (t) {
    ...
    if (!e.blockInteraction) {
        ...
        t.attachShadow({ mode: 'open', delegateFocus: true })
...
function atcb_set_global_event_listener(e, a) {
    ...
    if (a.lightMode == 'bodyScheme') {
        lightModeMutationObserver[a.identifier] = new MutationObserver(
            function (t) {
                t.forEach((t) => {
        ...
        lightModeMutationObserver[a.identifier].observe(
...
function atcb_global_listener_keyup(t) {
    const e = (function () {
        const t = document.querySelector(
            '[atcb-button-id="' + atcbStates['active'] + '"]'
        )
        if (t) {
            return t.shadowRoot
        }
...
function atcb_global_listener_keydown(a) {
    ...
    if (
        n &&
        n.querySelector('.atcb-list') &&
        (a.key === 'ArrowDown' || a.key === 'ArrowUp' || a.key === 'Tab')
    ) {
        a.preventDefault()
        let t = 0
        ...
        if (e && e.classList.contains('atcb-list-item')) {
            ...
            if (t > 0) {
                n.querySelector(
                    '.atcb-list-item[data-option-number="' + t + '"]'
                ).focus()
            }
        } else {
            switch (a.key) {
                ...
                case 'ArrowUp':
                    n.querySelector(
                        '.atcb-list-item[data-option-number="' + o + '"]'
                    ).focus()
                    break
            }
        }
